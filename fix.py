...
old_asi03 = "| **ASI03** | Identity Abuse | Roadmap - signed delegation. Ed25519 foundation ready. |"
...
# 2. Test count
txt = txt.replace("123/123 tests passing", "193/193 tests passing")
